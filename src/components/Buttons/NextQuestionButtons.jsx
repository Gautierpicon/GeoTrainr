    ...
    <div className="mt-6 flex items-center justify-center">
      <div className="group relative">
        <button
          onClick={onClick}
          disabled={disabled}
          className={`relative inline-block rounded-xl p-px leading-6 font-semibold text-white shadow-2xl transition-all duration-300 ${
            disabled
        ...
        >
          ...
          <span
            className={`relative z-10 block rounded-xl px-6 py-3 ${
